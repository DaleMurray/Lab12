...
public class Oval extends Shape
{
    ...
    public void draw(Graphics graphics)
    {
        ...
        int xPoint = location[0].x - (diameter1 / 2);
        int yPoint = location[0].y + (diameter2 / 2);
        ...
        if (this.isFilled())
        {
            graphics.fillOval(xPoint, yPoint, diameter1, diameter2);
        } 
        else
        {
            graphics.drawOval(xPoint, yPoint, diameter1, diameter2);
        }
    }
}
